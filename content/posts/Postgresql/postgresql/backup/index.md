...
To apply the changes, I had to add the configuration to /etc/patroni/patroni.yml, then delete the file /var/lib/postgresql/17/main/pg_hba.conf, and restart Patroni so it could recreate it.

```bash
$  cat /var/lib/postgresql/17/main/pg_hba.conf
# Do not edit this file manually!
# It will be overwritten by Patroni!
host replication replicator 172.20.20.211/32 md5
host replication replicator 172.20.20.212/32 md5
host replication replicator 172.20.20.213/32 md5
host replication replicator 127.0.0.1/32 trust
host all all 172.20.20.0/24 md5
host all all 0.0.0.0/0 md5
host all pmm 172.20.20.212/32 md5
host all all 192.168.210.0/24 md5
