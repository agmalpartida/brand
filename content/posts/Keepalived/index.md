...
This block defines a VRRP instance. Each instance represents a set of rules that Keepalived follows to switch between nodes.
  - interface ethX:
Specifies the network interface for this VRRP instance. It must be a valid interface on your system (e.g., eth0, eth1).
